...
object KeyCode {
    ...
    const val TOGGLE_UNICODE_MODE =       -10090
    const val TRANSLATE_TEXT =           -10091
    ...
    fun Int.checkAndConvertCode(longPress: Boolean = false): Int = if (this > 0) this else when (this) {
        ...
        BACKGROUND_GATHERING, BACKGROUND_GATHERING_TEMP_OFF, DPAD, TOGGLE_UNICODE_MODE, TRANSLATE_TEXT,
        -> this
